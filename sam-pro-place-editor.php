	...
	class SamProPlaceEditor {
		...
		private function getItemData( $item ) {
			...
			if ( $this->item > 0 ) {
				...
				$row = apply_filters( 'sam_pro_admin_place_default_data', array(
					...
					'cnt_style'     => "display: flex; flex-direction: row; justify-content: center;",
					'cnt_direction' => 0,
					'code_before'   => '',
					'code_after'    => '',
					'asize'         => '',
		...
		private function updateItemData( $id ) {
			...
			$updateRow = apply_filters( 'sam_pro_admin_place_save_data', array(
				...
				'cnt_style'     => stripslashes_deep( $_POST['cnt_style'] ),
				'cnt_direction' => ( ( isset( $_POST['cnt_direction'] ) ) ? (int)$_POST['cnt_direction'] : 0 ),
        ...
        <form method="post" action="<?php echo $this->action; ?>">
          ...
          <div class="metabox-holder has-right-sidebar" id="poststuff">
                        ...
                        <div id="misc-publishing-actions">
                          ...
                          <div class="misc-pub-section">
                            ...
                            <span id="place_size_info"
                                  class="post-status-display"><?php echo $apSize->name; ?></span><br>
                          ...
                          <div class="misc-pub-section">
                            <label for="trash_no">
                              <input type="radio" id="trash_no" value="0"
                                     name="trash" <?php checked( 0, $row['trash'] ); ?>>&nbsp;
															<?php _e( 'Is Active', SAM_PRO_DOMAIN ); ?>
                            </label><br>
                            <label for="trash_yes">
                              <input type="radio" id="trash_yes" value="1"
            ...
            <div id="post-body">
              <div id="post-body-content">
                  ...
                  <div id="tabs-1">
                    ...
                    <div class="meta-box-sortables ui-sortable">
                      <div id="codesdiv" class="postbox ">
                        ...
                        <div class="inside">
                          <p><b><?php _e('Styles', SAM_PRO_DOMAIN); ?></b></p>
                          <p><?php _e( 'Here you can define style for the Place container.', SAM_PRO_DOMAIN ); ?></p>
                          <p>
                            <label for="cnt_style"><?php _e( 'Place Container Style', SAM_PRO_DOMAIN ) ?></label>
                            <textarea id="cnt_style" name="cnt_style"><?php echo $row['cnt_style']; ?></textarea>
                          </p>
			                    <?php if ( $this->item > 0 ) { ?>
                          <div class="helpers">
                            <input id="cnt-center" type="button" class="button-secondary cnt-helper"
                                   value="<?php _e( 'Center', SAM_PRO_DOMAIN ); ?>">
                            <input id="cnt-left" type="button" class="button-secondary cnt-helper"
                                   value="<?php _e( 'Left', SAM_PRO_DOMAIN ); ?>">
                            <input id="cnt-right" type="button" class="button-secondary cnt-helper"
                                   value="<?php _e( 'Right', SAM_PRO_DOMAIN ); ?>">
                            <input id="cnt-float-left" type="button" class="button-secondary cnt-helper"
                                   value="<?php _e( 'Float Left', SAM_PRO_DOMAIN ); ?>">
                            <input id="cnt-float-right" type="button" class="button-secondary cnt-helper"
                                   value="<?php _e( 'Float Right', SAM_PRO_DOMAIN ); ?>">
                            <input id="cnt-sizes" type="button" class="button-secondary cnt-helper"
                                   value="<?php _e( 'Sizes', SAM_PRO_DOMAIN ); ?>">
                          </div>
                          <?php } ?>
                          <p><b><?php _e('Before/After Tags', SAM_PRO_DOMAIN); ?></b></p>
                          ...
                          <p><b><?php _e( 'Placement of the Before/After tags', SAM_PRO_DOMAIN ); ?></b></p>
                          <p>
                            <input type="radio" id="cnt_direction_0" name="cnt_direction"
                                   value="0" <?php checked( 0, (int) $row['cnt_direction'] ) ?>>
                            <label for="cnt_direction_0"><?php _e( 'Row', SAM_PRO_DOMAIN ); ?>  </label>
                            <input type="radio" id="cnt_direction_1" name="cnt_direction"
                                   value="1" <?php checked( 1, (int) $row['cnt_direction'] ) ?>>
                            <label for="cnt_direction_1"><?php _e( 'Column', SAM_PRO_DOMAIN ); ?>  </label>
                          </p>
                          <p>
                            <label for="code_before"><?php _e( 'Code Before', SAM_PRO_DOMAIN ); ?></label>
                            <input id="code_before" name="code_before" class="code" type="text"
                                   value="<?php echo htmlspecialchars( stripslashes( $row['code_before'] ) ); ?>"
                                   style="width: 100%;">
                          </p>
                          <p>
                            <label for="code_after"><?php _e( 'Code After', SAM_PRO_DOMAIN ); ?></label>
                            <input id="code_after" name="code_after" class="code" type="text"
                                   value="<?php echo htmlspecialchars( stripslashes( $row['code_after'] ) ); ?>"
                                   style="width: 100%;">
                          </p>
                    ...
                    <div class="meta-box-sortables ui-sortable">
                      <div id="codediv" class="postbox ">
                        ...
                        <div class="inside">
                          ...
                          <p>
                            <label for="amode_img">
                              <input id="amode_img" name="amode" type="radio"
                                     value="0" <?php checked( 0, $row['amode'] ); ?>><?php _e( 'Image', SAM_PRO_DOMAIN ); ?>
                            </label>
                          </p>
                          <div class="sub-content" id="rc-ami"<?php if ( $row['amode'] != 0 ) {
														echo ' style="display: none;"';
													} ?>>
                            <p>
                              <label for="img"><?php echo __( 'Image', SAM_PRO_DOMAIN ) . ':'; ?></label><br>
                              <input id="img" name="img" type="url" value="<?php echo $row['img'] ?>"
                                     style="width: 85%;">&nbsp;
                            ...
                            <p>
                              ...
                              <input id="link" name="link" type="url" value="<?php echo $row['link'] ?>"
                                     style="width: 100%;">
                            </p>
                            <p>
                              <label for="alt"><?php echo __( 'Alternative Text', SAM_PRO_DOMAIN ) . ':'; ?></label><br>
                              <input id="alt" name="alt" type="text" value="<?php echo $row['alt'] ?>"
                                     style="width: 100%;">
                            </p>
                          </div>
                          <p>
                            <label for="amode_code">
                              <input id="amode_code" name="amode" type="radio"
                                     value="1" <?php checked( 1, $row['amode'] ); ?>><?php _e( 'Code', SAM_PRO_DOMAIN ); ?>
                            </label>
                          </p>
                          <div class="sub-content" id="rc-amc"<?php if ( $row['amode'] != 1 ) {
														echo ' style="display: none;"';
													} ?>>
                            <p>
                              <label for="acode"><?php echo __( 'Default Ad Code', SAM_PRO_DOMAIN ) . ':'; ?></label>
                              <textarea id="acode" class="code" rows='10' name="acode"
                                        style="width:100%"><?php echo htmlspecialchars( stripslashes( $row['acode'] ) ); ?></textarea>
                              <input type='checkbox' name='inline' id='inline'
                                     value='1' <?php checked( 1, $row['inline'] ); ?>>
                              <label for='inline'
                                     style='vertical-align: middle;'> <?php _e( 'This is the set of inline ads', 'sam-pro' ); ?></label><br>
                              <input type='checkbox' name='php' id='php' value='1' <?php checked( 1, $row['php'] ); ?>>
                              <label for='php'
                                     style='vertical-align: middle;'> <?php _e( 'This code of ad contains PHP script', SAM_PRO_DOMAIN ); ?></label><br>
                              <input type='checkbox' name='ad_server' id='ad_server'
                                     value='1' <?php checked( 1, $row['ad_server'] ); ?>>
                              <label
                                for='ad_server'><?php _e( 'This is one-block code of third-party AdServer rotator. Selecting this checkbox prevents displaying contained ads.', SAM_PRO_DOMAIN ); ?></label>
                            </p>
                          </div>
                          <p>
                            <label for="amode_dfp">
                              <input id="amode_dfp" name="amode" type="radio"
                                     value="2" <?php checked( 2, $row['amode'] ); ?>><?php _e( 'Google DFP', SAM_PRO_DOMAIN ); ?>
                            </label>
                          </p>
                          <div class="sub-content" id="rc-amd"<?php if ( $row['amode'] != 2 ) {
														echo ' style="display: none;"';
													} ?>>
                            <p>
                        ...
                        <div class="inside">
                          <p>
                            <input id="sale" name="sale" type="checkbox"
                                   value="<?php echo $row['sale']; ?>" <?php checked( 1, $row['sale'] ); ?>>
                            <label for="sale"><?php _e( 'For Sale', SAM_PRO_DOMAIN ); ?></label>
                          </p>
                          <div id="rc-sale" class="sub-content"<?php if ( $row['sale'] == 0 ) {
														echo ' style="display: none;"';
													} ?>>
                            <label for="sale_mode_0">
                              <input id="sale_mode_0" name="sale_mode" type="radio"
                                     value="0" <?php checked( 0, $row['sale_mode'] ); ?>>
															<?php _e( 'Space', SAM_PRO_DOMAIN ); ?>
                            </label>&nbsp;&nbsp;
                            <label for="sale_mode_1">
                              <input id="sale_mode_1" name="sale_mode" type="radio"
                                     value="1" <?php checked( 1, $row['sale_mode'] ); ?>>
                            ...
                            <div id="rc-sale-mode" class="radio-content" <?php if ( (integer) $row['sale_mode'] != 0 ) {
															echo 'style="display:none;"';
														} ?>>
                              <p>
                                <label
                ...
                <div class="meta-box-sortables ui-sortable" style="margin-top: 20px;<?php if ( $this->item == 0 ) {
									echo ' display: none;';
								} ?>">
                  <div id="griddiv" class="postbox ">
                    ...
                    <div class="inside">
                      ...
                      <ul>
                        <li><i class="icon-ok"></i>/<i class="icon-traffic-cone"></i>
                          - <?php _e( 'Approved / Awaiting approval.', SAM_PRO_DOMAIN ); ?></li>
                        <li><i class="icon-leaf"></i>/<i class="icon-trash"></i>
                          - <?php _e( 'Is active / Is in trash.', SAM_PRO_DOMAIN ); ?></li>
                        <li><i class="icon-eye"></i>/<i class="icon-eye-off"></i>
                          - <?php _e( 'Potentially visible / Always invisible.', SAM_PRO_DOMAIN ); ?></li>
                      </ul>
                    </div>
                  </div>
                </div>
          ...
          <div id="adsDialog" title="<?php _e( 'Select Ads', SAM_PRO_DOMAIN ); ?>">
            ...
            <div class="sam-centered">
              <input type="button" id="select-ads" value="<?php _e( 'Select', SAM_PRO_DOMAIN ); ?>"
                     class="button-secondary">&nbsp;
              <input type="button" id="cancel-ads" value="<?php _e( 'Cancel', SAM_PRO_DOMAIN ); ?>"

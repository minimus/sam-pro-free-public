...
GROUP BY wss.pid, wss.aid;";
			...
			else return array('hits' => 0, 'clicks' => 0);
		}
		...
		private function updateItemData( $id ) {
			...
			$updateRow = apply_filters('sam_pro_admin_ad_save_data', array(
				...
				'swf_vars'    => stripslashes($_POST['swf_vars']),
				'swf_params'  => stripslashes($_POST['swf_params']),
				'swf_attrs'   => stripslashes($_POST['swf_attrs']),
				...
				'ptypes'      => ( ( isset( $_POST['ptypes'] ) ) ? $_POST['ptypes'] : 0 ),
				'eposts'      => ( ( isset( $_POST['eposts'] ) ) ? 1 : 0 ),
				'xposts'      => ( ( isset( $_POST['xposts'] ) ) ? $_POST['xposts'] : 0 ),
				'posts'       => stripslashes($_POST['posts']),
				'ecats'       => ( ( isset( $_POST['ecats'] ) ) ? 1 : 0 ),
				'xcats'       => ( ( isset( $_POST['xcats'] ) ) ? $_POST['xcats'] : 0 ),
				'cats'        => stripslashes($_POST['cats']),
				'etags'       => ( ( isset( $_POST['etags'] ) ) ? 1 : 0 ),
				'xtags'       => ( ( isset( $_POST['xtags'] ) ) ? $_POST['xtags'] : 0 ),
				'tags'        => stripslashes($_POST['tags']),
				'eauthors'    => ( ( isset( $_POST['eauthors'] ) ) ? 1 : 0 ),
				'xauthors'    => ( ( isset( $_POST['xauthors'] ) ) ? $_POST['xauthors'] : 0 ),
				'authors'     => stripslashes($_POST['authors']),
				'etax'        => ( ( isset( $_POST['etax'] ) ) ? 1 : 0 ),
				'xtax'        => ( ( isset( $_POST['xtax'] ) ) ? $_POST['xtax'] : 0 ),
				'taxes'       => stripslashes($_POST['taxes']),
				'etypes'      => ( ( isset( $_POST['etypes'] ) ) ? 1 : 0 ),
				'xtypes'      => ( ( isset( $_POST['xtypes'] ) ) ? $_POST['xtypes'] : 0 ),
				...
				'xvusers'     => stripslashes($_POST['xvusers']),
				'advertiser'  => ( ( isset( $_POST['advertiser'] ) ) ? 1 : 0 ),
				'geo'         => ( ( isset( $_POST['geo'] ) ) ? 1 : 0 ),
				'xgeo'        => ( ( isset( $_POST['xgeo'] ) ) ? $_POST['xgeo'] : 0 ),
				'geo_country' => ( ( isset( $_POST['geo_country'] ) ) ? stripslashes($_POST['geo_country']) : '' ),
				'geo_region'  => ( ( isset( $_POST['geo_region'] ) ) ? stripslashes($_POST['geo_region']) : '' ),
				'geo_city'    => ( ( isset( $_POST['geo_city'] ) ) ? stripslashes($_POST['geo_city']) : '' ),
				'owner'       => stripslashes($_POST['owner']),
				'owner_name'  => stripslashes($_POST['owner_name']),
				'owner_mail'  => stripslashes($_POST['owner_mail']),
				'ppm'         => 0.00,
				'ppc'         => 0.00,
				'ppi'         => 0.00,
			...
			<div class="wrap">
											...
											<div id="minor-publishing">
												...
												<div id="misc-publishing-actions">
													...
													<div class="misc-pub-section">
														...
														<span id="ad_clicks_info" style="font-weight: bold;"><?php echo $info['clicks']; ?></span><br>
									...
									<div id="tabs-1">
											...
											<div id="codediv" class="postbox ">
												...
												<div class="inside">
													...
													<div id="rc-cmf" class='radio-content' style="<?php if ( (int) $row['amode'] != 0 ) {
														...
														<p>
															<label for="img"><strong><?php echo __( 'Ad Image', SAM_PRO_DOMAIN ) . ':' ?></strong></label><br>
															<input id="img" class="code" type="text" tabindex="3" name="img" value="<?php echo $row['img']; ?>" style="width:85%">&nbsp;
														...
														<p>
															...
															<input id="link" class="code" type="text" tabindex="3" name="link" value="<?php echo $row['link']; ?>" style="width:100%">
														</p>
														<p>
															<label
																for="alt"><strong><?php echo __( 'Ad Alternative Text', SAM_PRO_DOMAIN ) . ':' ?></strong></label>
															<input id="alt" class="code" type="text" tabindex="3" name="alt" value="<?php echo $row['alt']; ?>" style="width:100%">
														</p>
														<p>
															<input type='checkbox' name='clicks' id='clicks' value='1' <?php checked( 1, $row['clicks'] ); ?> >
															<label for='clicks'><?php _e( 'Count clicks for this advertisement', SAM_PRO_DOMAIN ); ?></label>
														</p>
														...
														<div id="swf-params" class="radio-content" style="<?php if ( (int) $row['swf'] != 1 ) {
															...
															<label for="swf_vars"><strong><?php _e( 'Flash banner "flashvars"', SAM_PRO_DOMAIN ) ?>:</strong></label>
															<textarea name="swf_vars" id="swf_vars" rows="3" placeholder="<?php echo $help; ?>" style="width:100%;"><?php echo htmlspecialchars(stripslashes($row['swf_vars'])); ?></textarea>
															<button id="click-tag" class="button-secondary"<?php disabled(true, empty($row['link'])) ?>><?php _e('Insert clickTAG', SAM_PRO_DOMAIN); ?></button>
															<p><?php _e( 'Insert "flashvars" parameters between braces...', SAM_PRO_DOMAIN ); ?></p>
															<label for="swf_params"><strong><?php _e( 'Flash banner "params"', SAM_PRO_DOMAIN ) ?>:</strong></label>
															<textarea name="swf_params" id="swf_params" rows="3" placeholder="<?php echo $help; ?>" style="width:100%;"><?php echo htmlspecialchars(stripslashes($row['swf_params'])); ?></textarea>
															<p><?php _e( 'Insert "params" parameters between braces...', SAM_PRO_DOMAIN ); ?></p>
															<label for="swf_attrs"><strong><?php _e( 'Flash banner "attributes"', SAM_PRO_DOMAIN ) ?>:</strong></label>
															<textarea name="swf_attrs" id="swf_attrs" rows="3" placeholder="<?php echo $help; ?>" style="width:100%;"><?php echo htmlspecialchars(stripslashes($row['swf_attrs'])); ?></textarea>
															<p><?php _e( 'Insert "attributes" parameters between braces...', SAM_PRO_DOMAIN ); ?></p>
															<label for="swf_fallback"><?php _e('Flash banner fallback code', SAM_PRO_DOMAIN); ?>:</label>
															<textarea name="swf_fallback" id="swf_fallback" rows="3" style="width:100%;"><?php echo htmlspecialchars(stripslashes($row['swf_fallback'])); ?></textarea>
															<button id="fallback-code" class="button-secondary"><?php _e('Generate Fallback Image Code', SAM_PRO_DOMAIN); ?></button>
														</div>
														<p>
															<label for='rel'><strong><?php echo __( 'Add to ad', SAM_PRO_DOMAIN ) . ':'; ?></strong></label>
															<select name='rel' id='rel'>
																<option value='0' <?php selected( 0, $row['rel'] ); ?>><?php _e( 'Non Selected', SAM_PRO_DOMAIN ) ?></option>
																<option value='1' <?php selected( 1, $row['rel'] ); ?>><?php _e( 'nofollow', SAM_PRO_DOMAIN ) ?></option>
																<option value='2' <?php selected( 2, $row['rel'] ); ?>><?php _e( 'dofollow', SAM_PRO_DOMAIN ) ?></option>
																<option value='3' <?php selected( 3, $row['rel'] ); ?>><?php _e( 'noindex', SAM_PRO_DOMAIN ) ?></option>
																<option value='4' <?php selected( 4, $row['rel'] ); ?>><?php _e( 'nofollow and noindex', SAM_PRO_DOMAIN ) ?></option>
															</select>
														</p>
														<div class="clear"></div>
													</div>
													...
													<p>
														<input type='radio' name='amode' id='amode_true' value='1' <?php checked( 1, $row['amode'] ) ?>>
										...
										<div id="codes" class="meta-box-sortables ui-sortable">
											<div id="codediv" class="postbox ">
												...
												<div class="inside">
													<p>
														<input type='radio' name='ptype' id='ptype_0' value='0' <?php checked( 0, $row['ptype'] ); ?>>
														<label for='ptype_0'><strong><?php _e( 'Show ad on all pages of blog', SAM_PRO_DOMAIN ); ?></strong></label>
													</p>
													<p>
														<input type='radio' name='ptype' id='ptype_1' value='1' <?php checked( 1, $row['ptype'] ); ?>>
														<label for='ptype_1'><strong><?php echo __( 'Show ad only on pages of this type', SAM_PRO_DOMAIN ) . ':'; ?></strong></label>
													</p>
													<div id="rc-vt0" class='radio-content' style="<?php if ( (int) $row['ptype'] != 1 ) {	echo 'display: none;';} ?>">
														<ul id="page-types">
															<li id="<?php echo SAM_PRO_IS_HOME; ?>"><?php _e( 'Home Page (Home or Front Page)', SAM_PRO_DOMAIN ); ?></li>
															<li id="<?php echo SAM_PRO_IS_SINGULAR; ?>"><?php _e( 'Singular Pages', SAM_PRO_DOMAIN ); ?>
																<ul>
																	<li id="<?php echo SAM_PRO_IS_SINGLE; ?>"><?php _e( 'Single Post', SAM_PRO_DOMAIN ); ?></li>
																	<li id="<?php echo SAM_PRO_IS_PAGE; ?>"><?php _e( 'Page', SAM_PRO_DOMAIN ); ?></li>
																	<li id="<?php echo SAM_PRO_IS_POST_TYPE; ?>"><?php _e( 'Custom Post Type', SAM_PRO_DOMAIN ); ?></li>
																	<li id="<?php echo SAM_PRO_IS_ATTACHMENT; ?>"><?php _e( 'Attachment', SAM_PRO_DOMAIN ); ?></li>
																</ul>
															</li>
															<li id="<?php echo SAM_PRO_IS_SEARCH; ?>"><?php _e( 'Search Page', SAM_PRO_DOMAIN ); ?></li>
															<li id="<?php echo SAM_PRO_IS_404; ?>"><?php _e( '"Not found" Page (HTTP 404: Not Found)', SAM_PRO_DOMAIN ); ?></li>
															<li id="<?php echo SAM_PRO_IS_ARCHIVE; ?>"><?php _e( 'Archive Pages', SAM_PRO_DOMAIN ); ?>
																<ul>
																	<li id="<?php echo SAM_PRO_IS_TAX; ?>"><?php _e( 'Taxonomy Archive Pages', SAM_PRO_DOMAIN ); ?></li>
																	<li id="<?php echo SAM_PRO_IS_CATEGORY; ?>"><?php _e( 'Category Archive Pages', SAM_PRO_DOMAIN ); ?></li>
																	<li id="<?php echo SAM_PRO_IS_TAG; ?>"><?php _e( 'Tag Archive Pages', SAM_PRO_DOMAIN ); ?></li>
																	<li id="<?php echo SAM_PRO_IS_AUTHOR; ?>"><?php _e( 'Author Archive Pages', SAM_PRO_DOMAIN ); ?></li>
																	<li id="<?php echo SAM_PRO_IS_POST_TYPE_ARCHIVE; ?>"><?php _e( 'Custom Post Type Archive Pages', SAM_PRO_DOMAIN ); ?></li>
																	<li id="<?php echo SAM_PRO_IS_DATE; ?>"><?php _e( 'Date Archive Pages (any date-based archive pages, i.e. a monthly, yearly, daily or time-based archive)', SAM_PRO_DOMAIN ); ?></li>
																</ul>
															</li>
														</ul>
													</div>
									...
									<div id="tabs-2">
										<div id="xlimits" class="meta-box-sortables ui-sortable">
											<div id="limitsdiv" class="postbox ">
												<h3 class="hndle"><span><?php _e('Additional restrictions of the advertisement showing', SAM_PRO_DOMAIN);?></span></h3>
												<div class="inside">
													<p>
														<input type="checkbox" id="eposts" name="eposts" value="1" <?php checked(1, $row['eposts']); disabled(0, (integer)$this->settings['rule_id']); ?>>
														<label for="eposts"><?php _e('Enable restriction for posts/pages', SAM_PRO_DOMAIN); ?></label>
													</p>
													<div id="rc-posts" class="radio-content" <?php if((integer)$row['eposts'] != 1) echo 'style="display:none;"' ?>>
														<input type="radio" name="xposts" id="xposts_0" value="0" <?php checked( 0, $row['xposts'] ); ?>>
														<label for="xposts_0"><?php _e('Show', SAM_PRO_DOMAIN); ?></label>&nbsp;&nbsp;
														<input type="radio" name="xposts" id="xposts_1" value="1" <?php checked( 1, $row['xposts'] ); ?>>
														<label for="xposts_1"><?php _e('Do not show', SAM_PRO_DOMAIN); ?></label>
														<p>
															<input type="text" id="posts" name="posts" value="<?php echo $row['posts']; ?>" style="width: 85%;">&nbsp;
															<button id="showPosts" class="button-secondary"><?php _e('Select', SAM_PRO_DOMAIN); ?></button>
														</p>
													</div>
													<p><?php _e('Show the ad only on the certain pages. / Do not show the ad on the certain pages.', SAM_PRO_DOMAIN) ?></p>
													<div class="clear-line"></div>
													<p>
														<input type="checkbox" id="ecats" name="ecats" value="1" <?php checked(1, $row['ecats']); disabled(0, (integer)$this->settings['rule_categories']); ?>>
														<label for="ecats"><?php _e('Enable restriction for categories', SAM_PRO_DOMAIN); ?></label>
													</p>
													<div id="rc-cats" class="radio-content" <?php if((integer)$row['ecats'] != 1) echo 'style="display:none;"' ?>>
														<input type="radio" name="xcats" id="xcats_0" value="0" <?php checked( 0, $row['xcats'] ); ?>>
														<label for="xcats_0"><?php _e('Show', SAM_PRO_DOMAIN); ?></label>&nbsp;&nbsp;
														<input type="radio" name="xcats" id="xcats_1" value="1" <?php checked( 1, $row['xcats'] ); ?>>
														<label for="xcats_1"><?php _e('Do not show', SAM_PRO_DOMAIN); ?></label>
														<p>
															<input type="text" id="cats" name="cats" value="<?php echo $row['cats']; ?>" style="width: 85%;">&nbsp;
															<button id="showCats" class="button-secondary"><?php _e('Select', SAM_PRO_DOMAIN); ?></button>
														</p>
													</div>
													...
													<div class="clear-line"></div>
													<p>
														<input type="checkbox" id="etags" name="etags" value="1" <?php checked(1, $row['etags']); disabled(0, (integer)$this->settings['rule_tags']); ?>>
														<label for="etags"><?php _e('Enable restriction for tags', SAM_PRO_DOMAIN); ?></label>
													</p>
													<div id="rc-tags" class="radio-content" <?php if((integer)$row['etags'] != 1) echo 'style="display:none;"' ?>>
														<input type="radio" name="xtags" id="xtags_0" value="0" <?php checked( 0, $row['xtags'] ); ?>>
														<label for="xtags_0"><?php _e('Show', SAM_PRO_DOMAIN); ?></label>&nbsp;&nbsp;
														<input type="radio" name="xtags" id="xtags_1" value="1" <?php checked( 1, $row['xtags'] ); ?>>
														<label for="xtags_1"><?php _e('Do not show', SAM_PRO_DOMAIN); ?></label>
														<p>
															<input type="text" id="tags" name="tags" value="<?php echo $row['tags']; ?>" style="width: 85%;">&nbsp;
															<button id="showTags" class="button-secondary"><?php _e('Select', SAM_PRO_DOMAIN); ?></button>
														</p>
													</div>
													...
													<div class="clear-line"></div>
													<p>
														<input type="checkbox" id="eauthors" name="eauthors" value="1" <?php checked(1, $row['eauthors']); disabled(0, (integer)$this->settings['rule_authors']); ?>>
														<label for="eauthors"><?php _e('Enable restriction for authors', SAM_PRO_DOMAIN); ?></label>
													</p>
													<div id="rc-authors" class="radio-content" <?php if((integer)$row['eauthors'] != 1) echo 'style="display:none;"' ?>>
														<input type="radio" name="xauthors" id="xauthors_0" value="0" <?php checked( 0, $row['xauthors'] ); ?>>
														<label for="xauthors_0"><?php _e('Show', SAM_PRO_DOMAIN); ?></label>&nbsp;&nbsp;
														<input type="radio" name="xauthors" id="xauthors_1" value="1" <?php checked( 1, $row['xauthors'] ); ?>>
														<label for="xauthors_1"><?php _e('Do not show', SAM_PRO_DOMAIN); ?></label>
														<p>
															<input type="text" id="authors" name="authors" value="<?php echo $row['authors']; ?>" style="width: 85%;">&nbsp;
															<button id="showAuthors" class="button-secondary"><?php _e('Select', SAM_PRO_DOMAIN); ?></button>
														</p>
													</div>
													...
													<div class="clear-line"></div>
													<p>
														<input type="checkbox" id="etax" name="etax" value="1" <?php checked(1, $row['etax']); disabled(0, (integer)$this->settings['rule_taxes']); ?>>
														<label for="etax"><?php _e('Enable restriction for Custom Taxonomies Terms', SAM_PRO_DOMAIN); ?></label>
													</p>
													<div id="rc-tax" class="radio-content" <?php if((integer)$row['etax'] != 1) echo 'style="display:none;"' ?>>
														...
														<p>
															<input type="text" id="taxes" name="taxes" value="<?php echo $row['taxes']; ?>" style="width: 85%;">&nbsp;
															<button id="showTaxes" class="button-secondary"><?php _e('Select', SAM_PRO_DOMAIN); ?></button>
														</p>
													</div>
													...
													<div class="clear-line"></div>
													<p>
														<input type="checkbox" id="etypes" name="etypes" value="1" <?php checked(1, $row['etypes']); disabled(0, (integer)$this->settings['rule_types']); ?>>
														<label for="etypes"><?php _e('Enable restriction for Custom Post Types', SAM_PRO_DOMAIN); ?></label>
													</p>
													<div id="rc-types" class="radio-content" <?php if((integer)$row['etypes'] != 1) echo 'style="display:none;"' ?>>
														<input type="radio" name="xtypes" id="xtypes_0" value="0" <?php checked( 0, $row['xtypes'] ); ?>>
														<label for="xtypes_0"><?php _e('Show', SAM_PRO_DOMAIN); ?></label>&nbsp;&nbsp;
														<input type="radio" name="xtypes" id="xtypes_1" value="1" <?php checked( 1, $row['xtypes'] ); ?>>
														<label for="xtypes_1"><?php _e('Do not show', SAM_PRO_DOMAIN); ?></label>
														<p>
															<input type="text" id="types" name="types" value="<?php echo $row['types']; ?>" style="width: 85%;">&nbsp;
															<button id="showTypes" class="button-secondary"><?php _e('Select', SAM_PRO_DOMAIN); ?></button>
														</p>
													</div>
										...
										<div id="x2limits" class="meta-box-sortables ui-sortable">
											<div id="limitsdiv2" class="postbox ">
												<h3 class="hndle"><span><?php _e('Limitations of the ad showing', SAM_PRO_DOMAIN);?></span></h3>
												<div class="inside">
													<p>
														<input type="checkbox" id="schedule" name="schedule" value="1" <?php checked(1, $row['schedule']); disabled(0, (integer)$this->settings['rule_schedule']); ?>>
														<label for="schedule"><?php _e('Use the schedule for this ad', SAM_PRO_DOMAIN); ?></label>
													</p>
													<div id="rc-schedule" class="radio-content" <?php if((integer)$row['schedule'] != 1) echo 'style="display:none;"'; ?>>
														<p>
													...
													<div class="clear-line"></div>
													<p>
														<input type='checkbox' name='limit_hits' id='limit_hits' value='1' <?php checked(1, $row['limit_hits']); disabled(0, (integer)$this->settings['rule_hits']); ?>>
													...
													<div id="rc-hl" class="radio-content" style="<?php if((int)$row['limit_hits'] != 1) echo 'display: none;'; ?>">
														<p>
															...
															<input type='number' name='hits_limit' id='hits_limit' value='<?php echo $row['hits_limit']; ?>'>
														</p>
													</div>
													<p>
													...
													<div class='clear-line'></div>
													<p>
														<input type='checkbox' name='limit_clicks' id='limit_clicks' value='1' <?php checked(1, $row['limit_clicks']); disabled(0, (integer)$this->settings['rule_clicks']); ?>>
													...
													<div id="rc-cl" class="radio-content" style="<?php if((int)$row['limit_clicks'] != 1) echo 'display: none;'; ?>">
														<p>
															...
															<input type='number' name='clicks_limit' id='clicks_limit' value='<?php echo $row['clicks_limit']; ?>'>
														</p>
													</div>
													<p>
										...
										<div id="targeting" class="meta-box-sortables ui-sortable">
											<div id="limitsusr" class="postbox">
												...
												<div class="inside">
													...
													<p>
														<input type="radio" name="users" id="users_0" value="0" <?php checked(0, $row['users']); ?> >
														<label for="users_0"><?php _e('all users', SAM_PRO_DOMAIN); ?></label>&nbsp;&nbsp;
														<input type="radio" name="users" id="users_1" value="1" <?php checked(1, $row['users']); ?> >
														<label for="users_1"><?php _e('some users', SAM_PRO_DOMAIN); ?></label>
													</p>
													<div id="custom-users" class="sub-content" style="<?php if((int)$row['users'] != 1) echo 'display: none;'; ?>">
														<p>
															<input type="checkbox" name="users_unreg" id="users_unreg" value="1" <?php checked(1, $row['users_unreg']); ?> >
															<label for="users_unreg"><?php _e('Unregistered Users', SAM_PRO_DOMAIN); ?></label>
														</p>
														<p>
															<input type="checkbox" name="users_reg" id="users_reg" value="1" <?php checked(1, $row['users_reg']); ?> >
															<label for="users_reg"><?php _e('Registered Users', SAM_PRO_DOMAIN) ?></label>
														</p>
														<div id="x-reg-users" class="sub-content" style="<?php if((int)$row['users_reg'] != 1) echo 'display: none;'; ?>">
															<p>
																<input type="checkbox" name="xusers" id="xusers" value="1" <?php checked(1, $row['xusers']) ?> >
																<label for="xusers"><?php _e('Exclude these users', SAM_PRO_DOMAIN) ?></label>
															</p>
															<div id="x-view-users" class="sub-content" style="<?php if((int)$row['xusers'] != 1) echo 'display: none;'; ?>">
																<label for="xvusers"><?php echo __('Registered Users', SAM_PRO_DOMAIN).':'; ?></label>
																<input type="text" name="xvusers" id="xvusers" value="<?php echo $row['xvusers'] ?>" style="width: 85%;">
																<button id="showXUsers" class="button-secondary"><?php _e('Select', SAM_PRO_DOMAIN); ?></button>
															</div>
															<p>
																<input type="checkbox" name="advertiser" id="advertiser" value="1" <?php checked(1, $row['advertiser']); ?> >
																<label for="advertiser"><?php _e('Do not show this ad for advertiser', SAM_PRO_DOMAIN) ?></label>
															</p>
														</div>
													</div>
												</div>
											...
											<div id="adowner" class="postbox">
												...
												<div class="inside">
													<p>
														...
														<input id="owner" name="owner" type="text" value="<?php echo $row['owner']; ?>" style="width: 100%;">
													</p>
													<p>
														<label for="owner_name"><?php _e('Advertiser Name', SAM_PRO_DOMAIN); ?></label>
														<input id="owner_name" name="owner_name" type="text" value="<?php echo $row['owner_name']; ?>" style="width: 100%;">
													</p>
													<p>
														<label for="owner_mail"><?php _e('Advertiser e-mail', SAM_PRO_DOMAIN); ?></label>
														<input id="owner_mail" name="owner_mail" type="email" value="<?php echo $row['owner_mail']; ?>" style="width: 100%;">
													</p>
													<p>
														<input id="showAdvertisers" class="button-secondary" type="button" value="<?php echo __('Select', SAM_PRO_DOMAIN); ?>">
													</p>
												</div>
											</div>
										</div>
				...
				<div id="postsDialog" title="<?php _e('Select Posts', SAM_PRO_DOMAIN); ?>">
					...
					<div class="sam-centered">
						<input type="button" id="select-posts" value="<?php _e('Select', SAM_PRO_DOMAIN); ?>" class="button-secondary">&nbsp;
						<input type="button" id="cancel-posts" value="<?php _e('Cancel', SAM_PRO_DOMAIN); ?>" class="button-secondary cancel-dialog">
					</div>
				</div>
				<div id="catsDialog" title="<?php _e('Select Categories', SAM_PRO_DOMAIN); ?>">
					<div id="catsGrid"></div>
					<div class="sam-centered">
						<input type="button" id="select-cats" value="<?php _e('Select', SAM_PRO_DOMAIN); ?>" class="button-secondary">&nbsp;
						<input type="button" id="cancel-cats" value="<?php _e('Cancel', SAM_PRO_DOMAIN); ?>" class="button-secondary cancel-dialog">
					</div>
				</div>
				<div id="tagsDialog" title="<?php _e('Select Tags', SAM_PRO_DOMAIN); ?>">
					<div id="tagsGrid"></div>
					<div class="sam-centered">
						<input type="button" id="select-tags" value="<?php _e('Select', SAM_PRO_DOMAIN); ?>" class="button-secondary">&nbsp;
						<input type="button" id="cancel-tags" value="<?php _e('Cancel', SAM_PRO_DOMAIN); ?>" class="button-secondary cancel-dialog">
					</div>
				</div>
				<div id="authorsDialog" title="<?php _e('Select Authors', SAM_PRO_DOMAIN); ?>">
					<div id="authorsGrid"></div>
					<div class="sam-centered">
						<input type="button" id="select-authors" value="<?php _e('Select', SAM_PRO_DOMAIN); ?>" class="button-secondary">&nbsp;
						<input type="button" id="cancel-authors" value="<?php _e('Cancel', SAM_PRO_DOMAIN); ?>" class="button-secondary cancel-dialog">
					</div>
				</div>
				<div id="taxDialog" title="<?php _e('Select Custom Taxonomies Terms', SAM_PRO_DOMAIN); ?>">
					<div id="taxGrid"></div>
					<div class="sam-centered">
						<input type="button" id="select-tax" value="<?php _e('Select', SAM_PRO_DOMAIN); ?>" class="button-secondary">&nbsp;
						<input type="button" id="cancel-tax" value="<?php _e('Cancel', SAM_PRO_DOMAIN); ?>" class="button-secondary cancel-dialog">
					</div>
				</div>
				<div id="typesDialog" title="<?php _e('Select Custom Post Types', SAM_PRO_DOMAIN); ?>">
					<div id="typesGrid"></div>
					<div class="sam-centered">
						<input type="button" id="select-types" value="<?php _e('Select', SAM_PRO_DOMAIN); ?>" class="button-secondary">&nbsp;
						<input type="button" id="cancel-types" value="<?php _e('Cancel', SAM_PRO_DOMAIN); ?>" class="button-secondary cancel-dialog">
					</div>
				</div>
				<div id="usersDialog" title="<?php _e('Select Users', SAM_PRO_DOMAIN); ?>">
					<div id="usersGrid"></div>
					<div class="sam-centered">
						<input type="button" id="select-users" value="<?php _e('Select', SAM_PRO_DOMAIN); ?>" class="button-secondary">&nbsp;
						<input type="button" id="cancel-users" value="<?php _e('Cancel', SAM_PRO_DOMAIN); ?>" class="button-secondary cancel-dialog">
					</div>
				</div>
				<div id="advertsDialog" title="<?php _e('Select Advertiser', SAM_PRO_DOMAIN); ?>">
					<div id="advertsGrid"></div>
					<div class="sam-centered">
						<input type="button" id="select-adverts" value="<?php _e('Select', SAM_PRO_DOMAIN); ?>" class="button-secondary">&nbsp;
						<input type="button" id="cancel-adverts" value="<?php _e('Cancel', SAM_PRO_DOMAIN); ?>" class="button-secondary cancel-dialog">
					</div>
				</div>
			</div>
			<?php
